  ...
  <script>
    ...
    $(function() {
      ...
      // パスワード変更画面
      // 古いパスワード
      $('.js-show-pass-old').on('change', function() {
        if ($(this).prop('checked')) {
          $('.js-pass-old').attr('type', 'text');
        } else {
          $('.js-pass-old').attr('type', 'password');
        }
      });
      // 新しいパスワード
      $('.js-show-pass-new').on('change', function() {
        if ($(this).prop('checked')) {
          $('.js-pass-new').attr('type', 'text');
        } else {
          $('.js-pass-new').attr('type', 'password');
        }
      });
      // 新しいパスワード(大入力)
      $('.js-show-pass-new-re').on('change', function() {
        if ($(this).prop('checked')) {
          $('.js-pass-new-re').attr('type', 'text');
        } else {
          $('.js-pass-new-re').attr('type', 'password');
        }
      });

  ...
  <?php require('header.php'); ?>
    ...
    <section class="page-login">
      ...
      <form action="" method="post">
        ...
        <input type="checkbox" name="pass" class="js-show-pass-old">古いパスワードを表示する
        ...
        <input type="checkbox" name="pass" class="js-show-pass-new">新しいパスワードを表示する
        ...
        <span class="js-required notes-err" style="display:block; left:0;">※新しいパスワードをもう一度入力してください</span>
        ...
        <input type="checkbox" name="pass" class="js-show-pass-new-re">新しいパスワード(再入力)を表示する
